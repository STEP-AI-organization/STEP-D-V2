...
| 항목 | 월 |
|---|---|
| Cloud SQL `db-custom-2-8192` (전용코어 2vCPU·8GB · **2026-09-16 스펙업** — 분석 병렬 4 대비 선제, 사용자 지시) | **₩139,600** ($101.18) |
...
| **소계** | **≈ ₩195,000~210,000** (2026-09-16 DB 스펙업 반영 · 그전 ₩125,000~140,000) |
...
고정비(₩195,000~210,000 · 2026-09-16 DB 스펙업 반영) + 폴링(₩3,400) + **분당 ₩15.4**(벤더 11.1 + 인프라 4.3).
...
| 월 분량 | 변동비 | 합계 |
|---|---|---|
| **693분 (2026-09-02 실측 · 30일 40편 · 평균 17.3분)** | ₩11,000 | **≈ ₩209,000~224,000** |
| 1,800분 (60분 × 30편) | ₩27,700 | ≈ ₩226,000~241,000 |
| 6,000분 (60분 × 100편) | ₩92,400 | ≈ ₩291,000~306,000 |
