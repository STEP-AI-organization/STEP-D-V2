    ...
    <div className="mx-auto max-w-[1240px]">
      ...
      <Card className="mb-4 border-brand/20 bg-brand/[0.035]">
        <CardContent className="flex gap-3 p-3.5 text-[12px] leading-relaxed text-muted-foreground">
          ...
          <p>
            <strong className="font-semibold text-foreground">하이라이트는 클립의 조합입니다.</strong>{" "}
        ...
        <Card className="min-w-0">
          <CardHeader className="border-b border-border pb-3">
            ...
            <input
              ...
              className="mt-2 h-8 w-full rounded-md border border-border bg-background px-2.5 text-sm outline-none focus-visible:ring-2 focus-visible:ring-ring"
            />
          </CardHeader>
          <CardContent className="p-0">
            {candidates.length > 0 ? (
              ...
              <div className="flex min-h-64 flex-col items-center justify-center px-6 text-center">
                <Clapperboard className="mb-3 size-7 text-muted-foreground/50" />
              ...
              <>
                <ol className="divide-y divide-border">
                  {selected.map((clip, index) => (
                    <li key={clip.id} className="flex items-center gap-3 px-4 py-3">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="truncate text-[13px] font-semibold">{clip.title}</div>
                        <div className="mt-1 text-[11px] text-muted-foreground">{formatDuration(clip.durationSec)}</div>
                      </div>
                ...
                <div className="border-t border-border bg-muted/25 p-4">
                  <div className="flex items-center justify-between text-xs">
                    <span className="text-muted-foreground">클립 합산 길이</span>
